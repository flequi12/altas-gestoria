    ...
    properties: {
      ...
      contrato: {
        ...
        properties: {
          ...
          ocupacion: { type: 'string', description: 'Codigo de ocupacion CNO (4 digitos) si se conoce; si no, el texto del puesto' },
          nivelFormativo: { type: 'string', description: 'Codigo de nivel formativo si aparece' },
          tipoJornada: { type: 'string', description: 'Si parcial: D=dia, S=semana, M=mes, A=anual' },
          horasJornada: { type: 'string', description: 'Horas de jornada si es parcial' },
